			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						    <input type="radio" name="dumpmysql" id="optionsRadiosInline1" value="1" <?php if($vo['dumpmysql'] == 1): ?>checked="checked"<?php endif; ?> /> 是						    
						    <input type="radio" name="dumpmysql" id="optionsRadiosInline0" value="0" <?php if($vo['dumpmysql'] == 0): ?>checked="checked"<?php endif; ?> /> 否
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						    <input type="radio" name="cacheindex" id="optionsRadiosInline1" value="1" <?php if($vo['cacheindex'] == 1): ?>checked="checked"<?php endif; ?> /> 是
 						    <input type="radio" name="cacheindex" id="optionsRadiosInline0" value="0" <?php if($vo['cacheindex'] == 0): ?>checked="checked"<?php endif; ?> /> 否
						</div>
					</div>
