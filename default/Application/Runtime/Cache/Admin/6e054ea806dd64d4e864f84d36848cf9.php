			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">添加推荐位:</label>
						<div class="col-sm-5">
							<input type="text" name="name" value="<?php echo ($vo["name"]); ?>" class="form-control" id="inputname" placeholder="请填写推荐位">
						</div>
					</div>
			    	...
			    	<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="description" value="<?php echo ($vo["description"]); ?>" id="inputPassword3" placeholder="简介">
						</div>
					</div>
...
<script>
	var SCOPE = {
		...
		'jump_url' : '/admin.php?c=position&a=index',
